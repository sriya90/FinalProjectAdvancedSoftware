...
public class CourseController {
 ...
 return "mainPage";
    ...
    public String editActivity(@PathVariable Long id,Model model,HttpSession session,RedirectAttributes redirectAttributes) {
    ...
    public String editCourseActivity(@PathVariable Long id,Model model,HttpSession session,RedirectAttributes redirectAttributes) {
    	  Activity activity = activityService.getActivity(id);
    	  currentID = id;
    	  callFromCourse = true;
    	  model.addAttribute("ActivityName", activity.getActivityCourse() + " : "+  activity.getActivityName());
